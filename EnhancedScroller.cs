...
namespace EnhancedUI.EnhancedScroller
{
    ...
    public class EnhancedScroller : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        /// <summary>
        /// is custom value. 
        /// true : 데이터의 양이 스크롤에 표시할 수 있는 양보다 적을 때 스크롤 동작 안하게 함.
        /// </summary>
        public bool IsScrollLockShortData;

        /// <summary>
        /// is custom handler.
        /// Container Resize되었을 때 호출.
        /// </summary>
        public Action<Vector2> onResizedContainer;
        ...
        /// <summary>
        /// is custom value. IsScrollLockShortData 이 true 일 때 scrollLock 을 적용 하는 flag.
        /// </summary>
        ...
        private void _Resize(bool keepPosition)
        {
            ...
            onResizedContainer?.Invoke(_container.sizeDelta);
        ...
        void Awake()
        {
            ...
            go.transform.SetParent(_scrollRect.viewport ?? _scrollRectTransform);
            if (scrollDirection == ScrollDirectionEnum.Vertical)
